...
namespace rst
{
    ...
    public:
        ...
        void update_pixel(const Eigen::Vector3f& point);
    ...
    private:
        ...
        int get_index_ssaa(float x,float y);

        int width, height;
        int ssaa_w=2,ssaa_h=2;

        float pixel_size = 1.0/ssaa_w;
        float pixel_start_pos = pixel_size/2;
